...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('dealers.products.general.create', $data);
    }
    ...
    public function getPrice($product_id){
        ...
        return view('dealers.products.prices.create') -> with('id',$product_id) ;
    }
    ...
    public function getStock($product_id){
        ...
        return view('dealers.products.stock.create') -> with('id',$product_id) ;
    }
    ...
    public function addImages($product_id){
        return view('dealers.products.images.create')->withId($product_id);
    }
