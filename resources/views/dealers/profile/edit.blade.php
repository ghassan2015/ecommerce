                    ...
                    <div class="row match-height">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                @include('dealers.includes.alerts.success')
                                @include('dealers.includes.alerts.errors')
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$dealer -> name  }}" id="name"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   name="name">
                                                            @error("name")
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$dealer -> email  }}" id=""
                                                            <input type="text" value="{{$dealer -> email  }}" id=""
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   name="email">
